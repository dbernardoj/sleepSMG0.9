function stageData = loadEEGnotes(stageData, notesFile)
...
nLoff = recStart + (stageData.events.LightsOut(1)/stageData.srate)/86400;
...
nLon = recStart + (stageData.events.LightsOn(1)/stageData.srate)/86400;
